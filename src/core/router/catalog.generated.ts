...
export const GENERATED_MODELS: ModelRow[] = [
  ...
  ["~deepseek/deepseek-v4-flash-latest","DeepSeek V4 Flash Latest","~deepseek",1310720,0.0558,0.1767,0.0088],
  ...
  ["moonshotai/kimi-k3","Kimi K3","moonshotai",1048576,2,11.2,0.232],
  ...
  ["z-ai/glm-5.2","GLM 5.2","z-ai",1048576,0.4875,1.56,0.091],
